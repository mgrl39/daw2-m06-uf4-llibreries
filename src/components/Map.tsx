 ...
 */
const mapStyles = [
  { name: "☀️ Dia", url: "https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png" },
  { name: "🌃 Nit", url: "https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png" },
  { name: "🛰️ Satèlit", url: "https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}" },
  { name: "🛣️ Carrers", url: "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" },
 ...
 * TODO: ARREGLAR ESTO
 */
function Controls({ pos, setStyle }: { pos: LatLngTuple, setStyle: (idx: number) => void 
}) {
  const map = useMap();
